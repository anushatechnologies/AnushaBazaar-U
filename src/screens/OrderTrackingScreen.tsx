...
import { cancelOrder, getOrderById } from "../services/api/orders";
...
const styles = StyleSheet.create({
    ...
    floatingBack: { position: "absolute", left: 16, width: 44, height: 44, borderRadius: 22, backgroundColor: "#fff", justifyContent: "center", alignItems: "center", elevation: 6, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 6 },
    recenterBtn: { position: "absolute", right: 16, width: 44, height: 44, borderRadius: 22, backgroundColor: "#fff", justifyContent: "center", alignItems: "center", elevation: 6, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 6 },
    etaPill: { position: "absolute", bottom: 30, alignSelf: "center", backgroundColor: "#fff", paddingHorizontal: 18, paddingVertical: 12, borderRadius: 30, flexDirection: "row", alignItems: "center", elevation: 8, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.12, shadowRadius: 10 },
    pulsingDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: "#0A8754", marginRight: 10 },
    etaText: { fontSize: 14, fontWeight: "700", color: "#222" },
    storeMarker: { backgroundColor: "#FF6B35", width: 32, height: 32, borderRadius: 16, justifyContent: "center", alignItems: "center", borderWidth: 2.5, borderColor: "#fff", elevation: 4 },
    homeMarkerWrap: { alignItems: "center" },
    homeMarker: { backgroundColor: "#3B82F6", width: 30, height: 30, borderRadius: 15, justifyContent: "center", alignItems: "center", borderWidth: 2.5, borderColor: "#fff", elevation: 4 },
    homeMarkerTip: { width: 0, height: 0, borderLeftWidth: 6, borderRightWidth: 6, borderTopWidth: 8, borderLeftColor: "transparent", borderRightColor: "transparent", borderTopColor: "#3B82F6", marginTop: -2 },
    riderOuter: { width: 44, height: 44, borderRadius: 22, backgroundColor: "rgba(10, 135, 84, 0.15)", justifyContent: "center", alignItems: "center" },
    riderInner: { width: 32, height: 32, borderRadius: 16, backgroundColor: "#0A8754", justifyContent: "center", alignItems: "center", borderWidth: 2.5, borderColor: "#fff", elevation: 6 },
    sheet: { flex: 1, backgroundColor: "#fff", marginTop: -20, borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingHorizontal: 20, elevation: 10 },
    ...
    statusDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: "#0A8754", marginRight: 8 },
    statusLabel: { fontSize: 13, color: "#0A8754", fontWeight: "600" },
    callBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: "#EAF7F1", justifyContent: "center", alignItems: "center" },
    partnerCard: { flexDirection: "row", alignItems: "center", marginTop: 16, backgroundColor: "#F8FAF9", padding: 14, borderRadius: 16 },
    partnerAvatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: "#E8F5E9", justifyContent: "center", alignItems: "center" },
    partnerInfo: { flex: 1, marginLeft: 14 },
    partnerLabel: { fontSize: 10, color: "#888", fontWeight: "700", letterSpacing: 0.8 },
    partnerName: { fontSize: 15, fontWeight: "700", color: "#111", marginTop: 2 },
    ratingBox: { flexDirection: "row", alignItems: "center", backgroundColor: "#fff", paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8, borderWidth: 1, borderColor: "#eee" },
    ratingText: { fontSize: 12, fontWeight: "700", marginLeft: 4, color: "#333" },
    chatBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: "#EAF7F1", justifyContent: "center", alignItems: "center", marginLeft: 8 },
    divider: { height: 1, backgroundColor: "#f2f2f2", marginVertical: 20 },
    timelineContainer: { paddingBottom: 10 },
    timelineTitle: { fontSize: 16, fontWeight: "800", color: "#111", marginBottom: 18 },
    timelineRow: { flexDirection: "row", minHeight: 58 },
    timelineLeft: { width: 32, alignItems: "center" },
    dot: { width: 26, height: 26, borderRadius: 13, backgroundColor: "#F0F0F0", justifyContent: "center", alignItems: "center", zIndex: 2 },
    dotCompleted: { backgroundColor: "#0A8754" },
    dotActive: { width: 32, height: 32, borderRadius: 16, backgroundColor: "#0A8754", borderWidth: 4, borderColor: "#D4EDDA" },
    line: { width: 2.5, flex: 1, backgroundColor: "#E8E8E8", marginVertical: -1 },
    lineCompleted: { backgroundColor: "#0A8754" },
    timelineBody: { flex: 1, marginLeft: 14, paddingBottom: 24 },
    stepTitle: { fontSize: 14, fontWeight: "700", color: "#333" },
    stepTitlePending: { color: "#B0B0B0", fontWeight: "500" },
    stepTitleActive: { color: "#0A8754", fontSize: 15, fontWeight: "800" },
    stepTime: { fontSize: 12, color: "#888", marginTop: 3 },
    detailsBtn: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#F9F9F9", padding: 16, borderRadius: 14, borderWidth: 1, borderColor: "#eee" },
    detailsBtnText: { fontSize: 14, fontWeight: "700", color: "#333" },
    cancelBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", marginTop: 16, paddingVertical: 16, borderRadius: 14, borderWidth: 1.5, borderColor: "#FECACA", backgroundColor: "#FEF2F2" },
    ...
    reasonOption: { flexDirection: "row", alignItems: "center", paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "#f1f1f1" },
    radio: { width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: "#D1D5DB", justifyContent: "center", alignItems: "center", marginRight: 12 },
    ...
    otherInput: { borderWidth: 1, borderColor: "#E5E7EB", borderRadius: 12, padding: 12, marginTop: 15, height: 80, textAlignVertical: "top", fontSize: 14 },
    modalFooter: { flexDirection: "row", marginTop: 25, gap: 12 },
    keepBtn: { flex: 1, paddingVertical: 14, borderRadius: 12, backgroundColor: "#F3F4F6", alignItems: "center" },
    keepBtnText: { fontSize: 15, fontWeight: "700", color: "#4B5563" },
    confirmCancelBtn: { flex: 1, backgroundColor: "#EF4444", paddingVertical: 14, borderRadius: 12, alignItems: "center", justifyContent: "center" },
    confirmCancelBtnText: { color: "#fff", fontSize: 16, fontWeight: "700" },
    detailsSection: { paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: "#F3F4F6" },
    sectionHeading: { fontSize: 12, fontWeight: "800", color: "#9CA3AF", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 12 },
    orderItemRow: { flexDirection: "row", alignItems: "center", marginBottom: 10 },
    itemQuantityBadge: { backgroundColor: "#F3F4F6", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, borderWidth: 1, borderColor: "#E5E7EB" },
    itemQuantityText: { fontSize: 12, fontWeight: "700", color: "#4B5563" },
    itemNameText: { fontSize: 14, fontWeight: "600", color: "#111827" },
    itemVariantText: { fontSize: 12, color: "#6B7280" },
    itemPriceText: { fontSize: 14, fontWeight: "700", color: "#111827" },
    addressBox: { flexDirection: "row", alignItems: "flex-start", backgroundColor: "#F9FAFB", padding: 12, borderRadius: 12 },
    addressValueText: { flex: 1, marginLeft: 10, fontSize: 14, color: "#4B5563", lineHeight: 20 },
    ...
    pricingValue: { fontSize: 14, fontWeight: "600", color: "#111827" },
    closeDetailsBtn: { backgroundColor: "#F3F4F6", paddingVertical: 14, borderRadius: 12, alignItems: "center", marginTop: 10 },
    closeDetailsBtnText: { fontSize: 16, fontWeight: "700", color: "#4B5563" },
});
