...
const WishlistItem = ({ item, onMoveToCart, onRemove, onPress }: any) => {
  ...
  return (
    <TouchableOpacity style={styles.wishlistItem} onPress={() => onPress(item)} activeOpacity={0.8}>
...
const WishlistScreen = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <FloatingCart currentRoute="Wishlist" />
    </View>
  );
};
